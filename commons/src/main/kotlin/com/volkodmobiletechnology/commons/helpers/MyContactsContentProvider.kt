package com.volkodmobiletechnology.commons.helpers
...
import com.volkodmobiletechnology.commons.extensions.getIntValue
import com.volkodmobiletechnology.commons.extensions.getStringValue
import com.volkodmobiletechnology.commons.models.PhoneNumber
import com.volkodmobiletechnology.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.volkodmobiletechnology.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.volkodmobiletechnology.dialer" && packageName != "com.volkodmobiletechnology.smsmessenger" && packageName != "com.volkodmobiletechnology.calendar.pro") {
                return contacts
            }
