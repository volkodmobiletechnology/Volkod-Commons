...
import com.volkodmobiletechnology.commons.activities.BaseSimpleActivity
import com.volkodmobiletechnology.commons.compose.extensions.DEVELOPER_PLAY_STORE_URL
import com.volkodmobiletechnology.commons.databinding.DialogTitleBinding
import com.volkodmobiletechnology.commons.dialogs.*
import com.volkodmobiletechnology.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.volkodmobiletechnology.commons.helpers.*
import com.volkodmobiletechnology.commons.models.*
import com.volkodmobiletechnology.commons.views.MyTextView
import java.io.*
import java.util.*
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=com.volkodmobiletechnology.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.volkodmobiletechnology.gallery.pro" || applicationId == "com.volkodmobiletechnology.gallery.pro.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.volkodmobiletechnology.dialer.debug" else "com.volkodmobiletechnology.dialer"
                val className = "com.volkodmobiletechnology.dialer.activities.DialerActivity"
