...
import com.volkodmobiletechnology.commons.models.AlarmSound
import com.volkodmobiletechnology.commons.models.BlockedNumber
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.volkodmobiletechnology.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.volkodmobiletechnology.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.volkodmobiletechnology.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.volkodmobiletechnology."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.volkodmobiletechnology.contacts") && !packageName.startsWith("com.volkodmobiletechnology.dialer")) {
        true
    } else if ((packageName.startsWith("com.volkodmobiletechnology.contacts") || packageName.startsWith("com.volkodmobiletechnology.dialer")) && isQPlus()) {
