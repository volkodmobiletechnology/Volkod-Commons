...
import com.volkodmobiletechnology.commons.compose.extensions.rateStarsRedirectAndThankYou
import com.volkodmobiletechnology.commons.compose.screens.*
import com.volkodmobiletechnology.commons.compose.theme.AppThemeSurface
import com.volkodmobiletechnology.commons.dialogs.ConfirmationAdvancedAlertDialog
...
class AboutActivity : ComponentActivity() {
    ...
    private fun launchEmailIntent() {
        ...
        val address = if (packageName.startsWith("com.volkodmobiletechnology")) {
    ...
    private fun onPrivacyPolicyClick() {
        val appId = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.volkodmobiletechnology.")
