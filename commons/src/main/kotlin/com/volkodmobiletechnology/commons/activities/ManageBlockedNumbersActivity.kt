...
import com.volkodmobiletechnology.commons.compose.extensions.onEventValue
import com.volkodmobiletechnology.commons.compose.screens.ManageBlockedNumbersScreen
import com.volkodmobiletechnology.commons.compose.theme.AppThemeSurface
import com.volkodmobiletechnology.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.volkodmobiletechnology.commons.dialogs.ExportBlockedNumbersDialog
import com.volkodmobiletechnology.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.volkodmobiletechnology.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.volkodmobiletechnology.dialer")) {
