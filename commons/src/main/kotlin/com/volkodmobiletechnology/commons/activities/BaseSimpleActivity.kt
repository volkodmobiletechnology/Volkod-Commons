...
import com.volkodmobiletechnology.commons.asynctasks.CopyMoveTask
...
import com.volkodmobiletechnology.commons.extensions.*
import com.volkodmobiletechnology.commons.helpers.*
import com.volkodmobiletechnology.commons.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.volkodmobiletechnology.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.volkodmobiletechnology.com. Thanks"
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.volkodmobiletechnology")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.volkodmobiletechnology.")
