...
import com.volkodmobiletechnology.commons.databinding.ActivityCustomizationBinding
...
import com.volkodmobiletechnology.commons.models.MyTheme
import com.volkodmobiletechnology.commons.models.RadioItem
import com.volkodmobiletechnology.commons.models.SharedTheme
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isThankYou = packageName.removeSuffix(".debug") == "com.volkodmobiletechnology.thankyou"
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.volkodmobiletechnology.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
